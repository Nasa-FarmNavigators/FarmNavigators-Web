...
export default function InstForm() {
  ...
  return (
    <div>
      <PageMeta title="Cadastrar Instituições" description="Cadastro de instituições" />
      <PageBreadcrumb pageTitle="Cadastrar Instituições" />
      {/* Exibindo a mensagem */}
      {message && (
        <div
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <ComponentCard title="Localização da Instituição">
            <div className="space-y-4">
              <Label>Pesquise o endereço</Label>
              <div className="flex">
                <Input
                  ref={searchInputRef}
                  type="text"
              ...
              <Label>Selecione clicando no mapa</Label>
